...
function CreateOutwards() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios
        .post("http://localhost:9002/outwards", outward)
        .then((res) => {
      ...
      <div className="w-50 bg-white rounded p-3">
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-2">
            ...
            <input
              type="date"
              placeholder="Enter the date_of_del"
              className="form-control"
              value={date_of_del}
          ...
          <div className="mb-2">
            ...
            <input
              type="text"
              placeholder="Enter delivered_to"
              className="form-control"
              value={delivered_to}
          ...
          <div className="mb-2">
            ...
            <input
              type="number"
              placeholder="Mention the reciept number"
              className="form-control"
              value={receipt_no}
          ...
          <div className="form-group">
            ...
            <Link to="/outwards" className="btn btn-danger">
              Back
            </Link>
          </div>
        </form>
