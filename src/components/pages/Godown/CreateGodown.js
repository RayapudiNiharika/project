...
function CreateGodown()
 {
    ...
    const handleSubmit=async(e)=>
    {
        ...
        console.log(godown)
        try {
            await axios.post('http://localhost:9002/godown', godown)
                .then(res => {
            ...
            <div className='w-50 bg-white rounded p-3'>
                <form onSubmit={handleSubmit}>
                    ...
                    <div className='mb-2'>
                        ...
                        <input type="text" placeholder="manager" className='form-control'
                        value={manager}
                    ...
                    <div className='mb-2'>
                        ...
                        <input type="date" placeholder="Enter satrt_date" className='form-control'
                        value={start_date}
                    ...
                    <div className='form-group'>
                        ...
                        <Link to="/godown" className='btn btn-danger'>Back</Link>
                    </div>
